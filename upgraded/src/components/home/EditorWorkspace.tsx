            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <label className="text-sm" style={{ color: "var(--foreground)" }}>
                ...
                <span className="block text-xs mt-2" style={{ color: "var(--muted-foreground)" }}>
                  Pick one defense profile for the immunization step. `Nano Banana 2 layered` is the
                  best default, `Stable Diffusion layered` is the lighter DeeVid-focused option, and
                  the strict profiles may fail closed on tight GPUs instead of silently weakening.
                </span>
                {immunize ? (
                  <div
