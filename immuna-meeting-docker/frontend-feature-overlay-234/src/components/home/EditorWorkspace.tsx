      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm leading-relaxed" style={{ color: "var(--muted-foreground)" }}>
            ...
            API. The prepared editor keeps the whole photo frame instead of cropping everything to
            a square.
          </p>
        </div>
        <div
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <label className="text-sm" style={{ color: "var(--foreground)" }}>
                ...
                <span className="block text-xs mt-2" style={{ color: "var(--muted-foreground)" }}>
                  ...
                  and the Nano Banana profiles currently have the most developed layered defense stack.
                </span>
              </label>
