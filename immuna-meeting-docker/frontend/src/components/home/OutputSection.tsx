...
import { profileLabel } from "../../lib/immunizationProfiles";
    ...
    <Card className="min-h-[720px] gap-5">
      <div className="flex items-start justify-between gap-3 flex-wrap">
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: "var(--muted-foreground)" }}>
            Results from the upgraded API-backed defense workspace.
          </p>
        </div>
        {(device || modelSource) && (
          <div
      ...
      <div className="space-y-5">
        {isLoading ? (
          ...
          <div className="flex-1 rounded-2xl border-2 border-dashed flex flex-col items-center justify-center p-10 text-center" style={{ borderColor: "var(--border)", backgroundColor: "var(--muted)" }}>
            ...
            <p className="text-sm leading-relaxed max-w-md" style={{ color: "var(--muted-foreground)" }}>
              Upload an image, paint the protected region, and run the API workflow to see the
        ...
        >
          ...
          <p className="text-xs mt-1" style={{ color: "var(--muted-foreground)" }}>
            User-facing validation and confirmation messages returned by the upgraded API.
          </p>
          <pre
